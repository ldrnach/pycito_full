...
SIM_DURATION = 1.5
TARGET = os.path.join('examples','sliding_block','estimation_in_the_loop','final_for_paper','low_friction')
...
def main():
    ...
    campctools.run_piecewise_estimation_control(make_lowfriction_model(), 
                                    sp_contact,
                                    globalkernel,
                                    savedir = TARGET)
