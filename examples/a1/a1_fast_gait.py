...
def a1_fast_steps(a1):
    ...
    # Make the gait types
    gaits = [GaitType(stride_length=0.25, duration=0.25),
            GaitType(stride_length=0.25, duration=0.25)]
...
def a1_second_step_fast_optimization():
    # Get the footstep parameters
    savedir = os.path.join('examples','a1','foot_tracking_fast','secondstep')
    a1 = opttools.make_a1()
    feet, _, qtraj = a1_fast_steps(a1)
    duration = 0.25
    ...
    sourcedir = os.path.join('examples','a1','foot_tracking_fast','firststep','weight_1e+03','trajoptresults.pkl')
...
def a1_full_step_fast_optimization():
    savedir = os.path.join('examples','a1','foot_tracking_fast','fullstep')
    a1 = opttools.make_a1()
    feet, _, qtraj = a1_fast_steps(a1)
