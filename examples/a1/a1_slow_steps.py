...
def a1_first_step_slow_optimization():
    ...
    savedir = os.path.join('examples','a1','foot_tracking_slow','firststep')
    a1 = opttools.make_a1()
...
def a1_second_step_slow_optimization():
    # Get the footstep parameters
    savedir = os.path.join('examples','a1','foot_tracking_slow','secondstep')
    a1 = opttools.make_a1()
    feet, _, qtraj = a1_slow_steps(a1)
    duration = 0.25
...
def a1_full_step_slow_optimization():
    savedir = os.path.join('examples','a1','foot_tracking_slow','fullstep')
    a1 = opttools.make_a1()
    feet, _, qtraj = a1_slow_steps(a1)
