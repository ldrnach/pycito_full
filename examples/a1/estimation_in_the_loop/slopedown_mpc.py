...
TARGET = os.path.join('examples','a1','estimation_in_the_loop','mpc','slopedown',f'{DISTANCE}m')

SLOPE_START = (1, 0)
SLOPE_STOP = (2, -0.35)  # These parameters give a slope of about 20 degrees for 1m


def make_slopedown_terrain():
...
def make_slopedown_model():
    a1 = A1VirtualBase(terrain = make_slopedown_terrain())
    a1.Finalize()
    return a1
...
def plot_slope_terrain():
    terrain = make_slopedown_terrain()
