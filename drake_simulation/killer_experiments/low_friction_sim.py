...
from drake_simulation.environments import FlatGroundWithFrictionPatch
...
target = os.path.join('drake_simulation','killer_experiment','low_friction')
...
env = FlatGroundWithFrictionPatch()
