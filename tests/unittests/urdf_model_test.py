...
from pydrake.all import Parser, MultibodyPlant, RigidTransform, JacobianWrtVariable, MultibodyForces
...
class TestSlidingBlock(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        urdf_file = FindResource("systems/block/urdf/sliding_block.urdf")
    ...
    def test_num_positions(self):
        ...
        self.assertEqual(self.plant.num_positions(), 2, msg="Wrong number of position variables")

    def test_num_velocities(self):
        """Check the number of velocity variables in the model"""
        self.assertEqual(self.plant.num_velocities(), 2, msg="Wrong number of velocity variables")
