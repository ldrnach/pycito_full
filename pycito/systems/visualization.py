...
from pycito.utilities import FindResource, find_filepath_recursive, alphanumeric_sort, load
...
def a1_example():
    file = 'pycito/systems/A1/A1_description/urdf/a1_no_collision.urdf'
    vis = Visualizer(file)
    vis.visualize_trajectory()

if __name__ == "__main__":
    print("Hello from visualization.py!")
