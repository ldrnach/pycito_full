...
class full_observer_data_lcmt(object):
    __slots__ = ["q", "qd", "p_foot", "v_foot", "tau_est", "footforce", "p", "vWorld", "vBody", "rpy", "omegaBody", "omegaWorld", "quat"]

    __typenames__ = ["float", "float", "float", "float", "float", "int16_t", "float", "float", "float", "float", "float", "float", "float"]

    __dimensions__ = [[12], [12], [12], [12], [12], [4], [3], [3], [3], [3], [3], [3], [4]]

    def __init__(self):
        self.q = [ 0.0 for dim0 in range(12) ]
        self.qd = [ 0.0 for dim0 in range(12) ]
        self.p_foot = [ 0.0 for dim0 in range(12) ]
        self.v_foot = [ 0.0 for dim0 in range(12) ]
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(full_observer_data_lcmt._get_packed_fingerprint())
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack('>12f', *self.p_foot[:12]))
        buf.write(struct.pack('>12f', *self.v_foot[:12]))
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != full_observer_data_lcmt._get_packed_fingerprint():
            raise ValueError("Decode error")
        return full_observer_data_lcmt._decode_one(buf)
    decode = staticmethod(decode)

    def _decode_one(buf):
        self = full_observer_data_lcmt()
        self.q = struct.unpack('>12f', buf.read(48))
        self.qd = struct.unpack('>12f', buf.read(48))
        self.p_foot = struct.unpack('>12f', buf.read(48))
        self.v_foot = struct.unpack('>12f', buf.read(48))
    ...
    def _get_hash_recursive(parents):
        if full_observer_data_lcmt in parents: return 0
        tmphash = (0xa83d03a025dbf4c2) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if full_observer_data_lcmt._packed_fingerprint is None:
            full_observer_data_lcmt._packed_fingerprint = struct.pack(">Q", full_observer_data_lcmt._get_hash_recursive([]))
        return full_observer_data_lcmt._packed_fingerprint
    _get_packed_fingerprint = staticmethod(_get_packed_fingerprint)

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", full_observer_data_lcmt._get_packed_fingerprint())[0]
